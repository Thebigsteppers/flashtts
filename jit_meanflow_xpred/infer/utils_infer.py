...
sys.path.append(f"{_repo_root}/third_party/BigVGAN/")
...
from jit_meanflow_xpred.model import CFM
from jit_meanflow_xpred.model.utils import convert_char_to_pinyin, get_tokenizer  # noqa: E402
...
def load_model(
    ...
    if vocab_file == "":
        vocab_file = os.path.join(_script_dir, "examples", "vocab.txt")
    tokenizer = "custom"
